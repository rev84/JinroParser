...
Jinro = (function() {
  ...
  Jinro.prototype.syokei = {};

  Jinro.prototype.sitai = {};
  ...
  Jinro.prototype.setUranaiCO = function() {
    var day, hantei, k, memberIndex, results, targetIndex;
    results = [];
    for (memberIndex = k = 0; k < 4; memberIndex = ++k) {
      if ($('.uranaiCOname' + memberIndex).val() < 0) {
        continue;
      }
      this.uranaiCO[memberIndex] = [];
      results.push((function() {
        var l, results1;
        results1 = [];
        for (day = l = 0; l < 10; day = ++l) {
          targetIndex = $('.uranaiCO' + memberIndex + '_' + day).val();
          hantei = $('.uranaiCOhantei' + memberIndex + '_' + day).val();
          if (targetIndex < 0 || hantei < 0) {
            continue;
          }
          results1.push(this.uranaiCO[memberIndex].push([targetIndex, (hantei === 0 ? true : false)]));
        }
        return results1;
      }).call(this));
    }
  ...
  Jinro.prototype.setReinouCO = function() {
    ...
    results = [];
    for (memberIndex = k = 0; k < 4; memberIndex = ++k) {
      if ($('.reinouCOname' + memberIndex).val() < 0) {
        continue;
      }
      this.reinouCO[memberIndex] = [];
      results.push((function() {
        var l, results1;
        results1 = [];
        for (day = l = 0; l < 10; day = ++l) {
          ...
          results1.push(this.reinouCO[memberIndex].push([targetIndex, (hantei === 0 ? true : false)]));
        }
        return results1;
      }).call(this));
    }
  ...
  Jinro.prototype.setSyokei = function() {
    var day, k, results, syokeiIndex;
    results = [];
    for (day = k = 0; k < 10; day = ++k) {
      this.syokei[day] = [];
      syokeiIndex = $('.syokei' + d).val();
      if (syokeiIndex < 0) {
        results.push(this.syokei[day].push(syokeiIndex));
      } else {
        results.push(void 0);
      }
    }
  ...
  Jinro.prototype.setSitai = function() {
    var day, k, results, s, selects, syokeiIndex;
    results = [];
    for (day = k = 0; k < 10; day = ++k) {
      this.sitai[day] = [];
      selects = $('.sitai' + d);
      results.push((function() {
        var l, len, results1;
        results1 = [];
        for (l = 0, len = selects.length; l < len; l++) {
          s = selects[l];
          syokeiIndex = s.val();
          if (syokeiIndex < 0) {
            continue;
          }
          results1.push(this.syokei[day].push(syokeiIndex));
        }
        return results1;
      }).call(this));
    }
